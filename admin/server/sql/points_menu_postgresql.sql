...
VALUES 
(41, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, 0, 0, 'points', 'pointsManagement', false, 'view/gaia/points/index.vue', 3, '', false, false, '积分管理', 'coin', false);

-- 添加用户积分管理子菜单 (ID: 42)
INSERT INTO "sys_base_menus" 
("id", "created_at", "updated_at", "deleted_at", "menu_level", "parent_id", "path", "name", "hidden", "component", "sort", "active_name", "keep_alive", "default_menu", "title", "icon", "close_tab") 
VALUES 
(42, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, 0, 41, 'users', 'pointsUsers', false, 'view/gaia/points/users.vue', 1, '', true, false, '用户积分管理', 'user', false);

-- 添加签到记录子菜单 (ID: 43)  
INSERT INTO "sys_base_menus" 
("id", "created_at", "updated_at", "deleted_at", "menu_level", "parent_id", "path", "name", "hidden", "component", "sort", "active_name", "keep_alive", "default_menu", "title", "icon", "close_tab") 
VALUES 
(43, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, 0, 41, 'records', 'pointsRecords', false, 'view/routerHolder.vue', 2, '', false, false, '签到记录管理', 'document', false);

-- 添加积分流水子菜单 (ID: 44)
INSERT INTO "sys_base_menus" 
("id", "created_at", "updated_at", "deleted_at", "menu_level", "parent_id", "path", "name", "hidden", "component", "sort", "active_name", "keep_alive", "default_menu", "title", "icon", "close_tab") 
VALUES 
(44, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, 0, 41, 'transactions', 'pointsTransactions', false, 'view/routerHolder.vue', 3, '', false, false, '积分流水管理', 'money', false);

-- 添加积分配置子菜单 (ID: 45)
INSERT INTO "sys_base_menus" 
("id", "created_at", "updated_at", "deleted_at", "menu_level", "parent_id", "path", "name", "hidden", "component", "sort", "active_name", "keep_alive", "default_menu", "title", "icon", "close_tab") 
VALUES 
(45, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, 0, 41, 'config', 'pointsConfig', false, 'view/gaia/points/config.vue', 4, '', true, false, '积分配置管理', 'setting', false);
